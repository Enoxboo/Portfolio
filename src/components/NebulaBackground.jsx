...
// Defined outside the component so the React compiler doesn't warn about
// inline class declarations inside hooks/components.
class Star {
    constructor(canvas, ctx, trailRef) {
        this.canvas = canvas
        this.ctx = ctx
    ...
    update(time) {
        ...
        this.trailRef.current.forEach(point => {
...
function NebulaBackground() {
    ...
    useEffect(() => {
        ...
        stars = Array.from({ length: starCount }, () => new Star(canvas, ctx, trailRef))
